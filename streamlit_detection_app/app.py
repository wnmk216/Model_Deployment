"""
ระบบตรวจจับสายพันธุ์สุนัขด้วย YOLO (Streamlit version)
แปลงมาจากเวอร์ชัน Flask เดิม — รองรับทั้งการอัปโหลดวิดีโอและตรวจจับผ่านเว็บแคมแบบเรียลไทม์

โครงสร้างโฟลเดอร์ที่ต้องมี:
    app.py
    model/best.pt        <- โมเดลที่เทรนไว้แล้ว
    upload/               <- ไฟล์วิดีโอที่ผู้ใช้อัปโหลดจะถูกเก็บที่นี่
    .streamlit/config.toml  <- ธีมสีดำ-น้ำเงิน (ไม่ใช้ CSS)
"""
